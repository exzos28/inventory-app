...
import {
  ...
  COOKIE_SET_ERROR,
  COOKIE_DELETE_ERROR,
  NOT_FOUND_SAVED_INSTAGRAM_COOKIES,
} from '../Error';
...
export default class ErrorRepositoryImpl implements ErrorRepository {
  private static readonly _KIND_DESCRIPTION_DICTIONARY = {
    ...
    [COOKIE_SET_ERROR]: 'Set cookie error',
    [COOKIE_DELETE_ERROR]: 'Delete cookie error',
    [NOT_FOUND_SAVED_INSTAGRAM_COOKIES]: 'Not found user cookies in store',
  } as const;
