...
export default observer(function SelectUserToStocktaking({
  navigation,
}: RootStackBindingProps<'SelectUserToStocktaking'>) {
  const root = useRoot();
  ...
  const onUserSelect = useCallback(
    (user: User) => navigation.navigate('Stocktaking', {userId: user.id}),
    [navigation],
  );
